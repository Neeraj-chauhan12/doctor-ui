    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2 text-center">Doctor Login</h1>
          <p className="text-gray-600 text-center mb-8">Access your medical dashboard</p>
          ...
          {!loggedIn ? (
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">You are successfully logged in as a doctor.</p>
              <button
